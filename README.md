...
| :---: | :--- | :--- |
| **1** | **Chưa có cơ chế tự quản lý tài khoản** | Khách hàng khó tự đăng ký, đăng nhập và cập nhật thông tin cá nhân một cách chủ động. |
| **2** | **Phân công tài xế thủ công** | Việc tìm và phân công tài xế chủ yếu do nhân viên thực hiện, mất thời gian và khó xử lý khi số lượng chuyến tăng. |
| **3** | **Khó theo dõi trạng thái chuyến đi** | Khách hàng khó biết đang tìm tài xế, tài xế nào nhận chuyến, tài xế đã đến chưa hay chuyến đang ở trạng thái nào. |
| **4** | **Thanh toán chưa được quản lý tập trung** | Thông tin thanh toán chưa được quản lý thống nhất, gây khó khăn cho việc tra cứu và quản lý giao dịch. |
| **5** | **Khả năng mở rộng hạn chế** | Hệ thống hiện tại khó đáp ứng khi số lượng khách hàng và tài xế tăng lên. |
| **6** | **Phụ thuộc vào tổng đài / ứng dụng đơn giản** | Khách hàng chỉ có thể liên hệ tổng đài hoặc sử dụng ứng dụng đơn giản, chưa có nền tảng đặt xe đầy đủ. |
| **7** | **Xử lý tìm tài xế chưa tự động** | Khi tài xế được đề xuất không phản hồi hoặc từ chối, hệ thống chưa có cơ chế tự động tìm tài xế khác. |
| **8** | **Thiếu khả năng theo dõi vị trí tài xế** | Chưa có cơ chế quản lý vị trí tài xế để hỗ trợ tìm tài xế gần khách hàng và dự kiến thời gian đến. |
| **9** | **Khó quản lý hoạt động vận hành** | Bộ phận vận hành gặp khó khăn trong việc theo dõi chuyến đi, giám sát thông tin người dùng và quản lý hoạt động khi quy mô tăng. |
| **10** | **Khả năng phát triển tính năng mới hạn chế** | Hệ thống hiện tại chưa đáp ứng tốt yêu cầu phát triển thêm các loại dịch vụ, phương thức thanh toán hoặc kênh thông báo. |    



---

## 2. Tại sao cần một hệ thống mới?

1. **Trao quyền tự chủ cho khách hàng:** Cung cấp trải nghiệm hiện đại cho phép khách hàng tự đăng ký, đăng nhập và quản lý thông tin cá nhân.
2. **Tự động hóa việc tìm và phân công tài xế:** Giảm sự phụ thuộc vào nhân viên vận hành và rút ngắn thời gian tìm tài xế.
3. **Cải thiện trải nghiệm khách hàng:** Cho phép khách hàng đặt xe, theo dõi trạng thái chuyến đi và biết thông tin tài xế theo thời gian thực.
4. **Quản lý thanh toán tập trung:** Quản lý thông tin và kết quả giao dịch một cách thống nhất, hỗ trợ cả tiền mặt và thanh toán điện tử.
5. **Nâng cao hiệu quả vận hành:** Nhân viên có thể hỗ trợ tra cứu, quản lý khách hàng, tài xế, phương tiện và chuyến đi trên cùng một hệ thống.
6. **Hỗ trợ mở rộng & phát triển tương lai:** Cung cấp kiến trúc linh hoạt, phục vụ số lượng lớn người dùng và dễ dàng tích hợp thêm dịch vụ mới.

> **Mục tiêu của hệ thống mới:** Xây dựng nền tảng CAB hiện đại, tự động và có khả năng mở rộng, hỗ trợ toàn bộ quy trình từ **Quản lý khách hàng → Đặt xe → Tìm tài xế → Thực hiện chuyến → Tính cước → Thanh toán → Đánh giá**.

---

## 3. Stakeholder chính & Ma trận Stakeholder

| # | Stakeholder | Vai trò | Tầm quan trọng |
| :---: | :--- | :--- | :--- |
| **1** | **Khách hàng (Customer)** | Đăng ký tài khoản, quản lý thông tin cá nhân, đặt xe, theo dõi chuyến đi, thanh toán và đánh giá. | **Rất quan trọng** – Người sử dụng trực tiếp tạo ra yêu cầu chuyến. |
| **2** | **Tài xế (Driver)** | Nhận chuyến, thực hiện chuyến và cập nhật trạng thái. | **Rất quan trọng** – Trực tiếp cung cấp dịch vụ vận chuyển. |
| **3** | **Nhân viên vận hành (Operation Staff)** | Quản lý khách hàng, tài xế, phương tiện và theo dõi chuyến đi. | **Rất quan trọng** – Đảm bảo duy trì và xử lý sự cố vận hành. |
| **4** | **Bộ phận Tài chính (Finance/Accounting)** | Theo dõi thanh toán, giao dịch và doanh thu. | **Quan trọng** – Quản lý đối soát và nguồn thu. |
| **5** | **Ban giám đốc (Management)** | Theo dõi báo cáo và đưa ra quyết định kinh doanh. | **Quan trọng** – Định hướng chiến lược phát triển. |
| **6** | **Nhà cung cấp thanh toán (Payment Provider)** | Xử lý các giao dịch thanh toán điện tử. | **Quan trọng** – Đảm bảo thanh toán an toàn, chính xác. |
| **7** | **Nhà cung cấp thông báo (Notification Provider)** | Gửi thông báo đến khách hàng và tài xế. | **Quan trọng** – Truyền tải thông tin quan trọng thời gian thực. |
| **8** | **Nhà cung cấp bản đồ/vị trí (Map Provider)** | Cung cấp dữ liệu vị trí, định tuyến và hỗ trợ tìm tài xế. | **Quan trọng** – Nền tảng định vị và tính khoảng cách. |
...
| ID | Business Goal |
| :---: | :--- |
| **BG-01** | Chuẩn hóa quy trình đăng ký, đăng nhập và tự quản lý thông tin cá nhân tiện lợi cho khách hàng. |
| **BG-02** | Cung cấp quy trình đặt xe nhanh chóng, đơn giản trên giao diện người dùng. |
| **BG-03** | Tự động hóa quá trình tìm và phân công tài xế, giảm sự phụ thuộc vào nhân viên vận hành. |
| **BG-04** | Đảm bảo chuyến xe được thực hiện và quản lý đầy đủ từ khi tài xế nhận chuyến đến khi hoàn thành. |
| **BG-05** | Cải thiện khả năng theo dõi chuyến và trải nghiệm minh bạch cho khách hàng. |
| **BG-06** | Quản lý việc tính cước và thanh toán chính xác, an toàn và thuận tiện. |
| **BG-07** | Đảm bảo khách hàng và tài xế nhận được thông tin kịp thời về chuyến đi và giao dịch. |
| **BG-08** | Nâng cao hiệu quả quản lý, giám sát vận hành và dữ liệu hệ thống của doanh nghiệp. |
| **BG-09** | Đảm bảo hệ thống hoạt động an toàn, xác thực đúng đối tượng và bảo vệ dữ liệu người dùng. |

# Business Requirements

| ID | Business Requirement | Business Goal |
| :---: | :--- | :---: |
| **BR-01** | **Quản lý khách hàng:** Hệ thống phải cung cấp cho khách hàng khả năng tự đăng ký, đăng nhập và quản lý thông tin cá nhân. | BG-01 |
| **BR-02** | **Đặt xe:** Hệ thống phải hỗ trợ khách hàng tạo yêu cầu đặt xe dựa trên điểm đón, điểm đến và loại xe. | BG-02 |
| **BR-03** | **Tìm tài xế:** Hệ thống phải tự động tìm và phân công tài xế phù hợp với yêu cầu đặt xe. | BG-03 |
| **BR-04** | **Thực hiện chuyến:** Hệ thống phải hỗ trợ quản lý toàn bộ quá trình thực hiện chuyến xe. | BG-04 |
| **BR-05** | **Theo dõi chuyến:** Hệ thống phải cung cấp thông tin trạng thái chuyến và tài xế cho khách hàng. | BG-05 |
| **BR-06** | **Tính cước & thanh toán:** Hệ thống phải tính số tiền khách hàng phải trả và hỗ trợ các phương thức thanh toán được doanh nghiệp chấp nhận. | BG-06 |
| **BR-07** | **Thông báo:** Hệ thống phải gửi thông báo cho khách hàng và tài xế về các sự kiện quan trọng. | BG-07 |
| **BR-08** | **Quản lý vận hành:** Hệ thống phải cung cấp công cụ để nhân viên vận hành tra cứu thông tin khách hàng, quản lý tài xế, phương tiện và theo dõi chuyến đi. | BG-08 |
| **BR-09** | **Bảo mật & dữ liệu:** Hệ thống phải xác thực người dùng, kiểm soát quyền truy cập và bảo vệ dữ liệu quan trọng. | BG-09 |
# Functional Requirements

| Business Requirement | Functional Requirements |
| :--- | :--- |
| **BR-01: Quản lý khách hàng** | • **FR-01.1:** Cho phép khách hàng đăng ký tài khoản mới.<br>• **FR-01.2:** Cho phép khách hàng đăng nhập và đăng xuất.<br>• **FR-01.3:** Cho phép khách hàng xem và cập nhật thông tin cá nhân (Họ tên, email, ảnh đại diện). |
| **BR-02: Đặt xe** | • **FR-02.1:** Cho phép khách hàng nhập điểm đón và điểm đến.<br>• **FR-02.2:** Cho phép khách hàng chọn loại xe và gửi yêu cầu đặt xe.<br>• **FR-02.3:** Ghi nhận yêu cầu và tạo chuyến đi trong hệ thống. |
| **BR-03: Tìm tài xế** | • **FR-03.1:** Xác định tài xế đang sẵn sàng và phù hợp gần vị trí khách hàng.<br>• **FR-03.2:** Ưu tiên phân công tài xế dựa trên vị trí và tiêu chí vận hành.<br>• **FR-03.3:** Gửi yêu cầu chuyến và ghi nhận phản hồi (Đồng ý/Từ chối) của tài xế.<br>• **FR-03.4:** Tự động chuyển tìm tài xế khác khi tài xế được đề xuất từ chối hoặc hết thời gian phản hồi.<br>• **FR-03.5:** Thông báo cho khách hàng khi không tìm thấy tài xế phù hợp. |
| **BR-04: Thực hiện chuyến** | • **FR-04.1:** Cho phép tài xế tiếp nhận chuyến xe.<br>• **FR-04.2:** Cho phép tài xế cập nhật các trạng thái chuyến đi (Đang đến điểm đón, Đã đón khách, Đang di chuyển, Hoàn thành).<br>• **FR-04.3:** Ghi nhận và lưu giữ trạng thái chuyến đi theo thời gian thực. |
| **BR-05: Theo dõi chuyến** | • **FR-05.1:** Hiển thị trạng thái hiện tại của chuyến cho khách hàng.<br>• **FR-05.2:** Hiển thị thông tin tài xế (Họ tên, SĐT, Đánh giá) và phương tiện (Biển số, Loại xe).<br>• **FR-05.3:** Cập nhật liên tục thay đổi trạng thái chuyến đi trên giao diện khách hàng. |
| **BR-06: Tính cước & thanh toán** | • **FR-06.1:** Tự động tính tổng tiền cước khách hàng phải trả khi hoàn thành chuyến.<br>• **FR-06.2:** Hỗ trợ linh hoạt các hình thức thanh toán (Tiền mặt, Ví điện tử/Thẻ).<br>• **FR-06.3:** Ghi nhận kết quả giao dịch thanh toán vào hệ thống.<br>• **FR-06.4:** Thông báo hóa đơn và kết quả thanh toán cho khách hàng. |
| **BR-07: Thông báo** | • **FR-07.1:** Gửi thông báo xác nhận khi yêu cầu đặt xe được hệ thống tiếp nhận.<br>• **FR-07.2:** Gửi thông báo khi có tài xế nhận chuyến và các thay đổi trạng thái trong chuyến đi.<br>• **FR-07.3:** Gửi thông báo kết quả giao dịch thanh toán.<br>• **FR-07.4:** Gửi thông báo phát chuyến mới hoặc các thay đổi liên quan đến lịch trình cho tài xế. |
...
| **RULE-07** | **UC11** | Điều kiện tìm tài xế | Hệ thống CAB, Tài xế | Hệ thống chỉ lựa chọn những tài xế đang sẵn sàng và đáp ứng các tiêu chí phù hợp với yêu cầu của khách hàng. |
| **RULE-08** | **UC11** | Ưu tiên tài xế | Hệ thống CAB | Khi có nhiều tài xế phù hợp, hệ thống ưu tiên tài xế đáp ứng tốt tiêu chí và có vị trí gần khách hàng để giảm thời gian chờ. |
| **RULE-09** | **UC11** | Tài xế từ chối chuyến | Hệ thống CAB, Tài xế | Khi tài xế từ chối, hệ thống ghi nhận kết quả và tiếp tục tìm kiếm tài xế khác phù hợp với chuyến đi. |
| **RULE-10** | **UC11** | Tài xế không phản hồi | Hệ thống CAB, Tài xế | Nếu tài xế không phản hồi trong thời gian quy định, hệ thống ghi nhận trạng thái không phản hồi và tiếp tục gửi yêu cầu đến tài xế khác. |
